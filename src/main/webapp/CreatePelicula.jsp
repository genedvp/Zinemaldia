            ...
            <div class="row">
                <div class="col">
                    <form action="StorePelicula" method="POST">
						...
						<p class="text-light mt-3">Titulo: </p><input type="text" class="form-control" name="titulo" value="${pelicula.titulo}"/>
						<p class="text-light mt-3"> Director: </p><input type="text" class="form-control" name="director" value="${pelicula.director}"/>
						<p class="text-light mt-3"> Descripcion: </p><input type="text" class="form-control" name="descripcion" value="${pelicula.descripcion}"/>
