...
<body class="bg-dark">
	...
	<div class="container">
            ...
            <div class="row">
                <div class="col">
                    <form action="StoreSala" method="POST">
                    	<input type="hidden" name="idSala" value="${sala.idSala}"/>
						<p class="text-light mt-3">Capacidad: </p><input type="text" class="form-control" name="capacidad" value="${sala.capacidad}"/>
						<p class="text-light mt-3">Descripción: </p><input type="text" class="form-control" name="descripcion" value="${sala.descripcion}"/>
