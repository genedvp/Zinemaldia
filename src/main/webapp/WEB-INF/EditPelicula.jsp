            ...
            <div class="row">
                <div class="col">
                    <form action="UpdateSala" method="POST">
						...
						<p class="text-light">Capacidad: </p><input type="text" class="form-control" name="capacidad" value="${sala.capacidad}"/>
						<p class="text-light">Descripcion: </p><input type="text" class="form-control" name="descripcion" value="${sala.descripcion}"/>
