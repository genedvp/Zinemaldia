					...
					<tbody>
						<c:forEach items="${peliculas}" var="pelicula">
							<tr class="table-active">
								...
								<td><a
									href="ShowPelicula?idPelicula=${pelicula.idPelicula}"> <svg
