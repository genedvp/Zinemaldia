...
<title>Panel de Control Sala</title>
...
<body class="bg-dark">
	...
	<div class="container-fluid text-center">
  		<div class="row">
            <div id="barraLateral" class="d-flex col-3 col-sm-2 col-lg-3 flex-nowrap bg-white flex-sm-column flex-column">
                <h3 class="text-body-secondary mt-4">Panel de Control</h3>
    		           ...
    		           <table class="table table-dark table-striped table-hover">
                        ...
                        <c:forEach items="${salas}" var="salas">
                          <tr class="table-active">
                            ...
                            <td>
                            	<a href="ShowSala?idPelicula=${pelicula.id}">
                            	<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="white" class="bi bi-search" viewBox="0 0 16 16"><path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/></svg>
                            	</a>
                            	<a href="EditPelicula?idPelicula=${pelicula.id}">
                            	...
                            	<a href="DestroyPelicula?idPelicula=${pelicula.id}">
