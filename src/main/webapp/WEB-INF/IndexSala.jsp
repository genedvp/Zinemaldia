	...
	<div class="container-fluid text-center">
		<div class="row">
			<div id="barraLateral"
				...
				<a href="#" class="text-body-secondary text-decoration-none"> <svg
			...
			<div class="flex-column col-7 col-sm-8 col-lg-9 mt-4">
				<a href="CreateSala"> <svg xmlns="http://www.w3.org/2000/svg"
						width="30" height="30" fill="white" class="bi bi-plus-lg"
						viewBox="0 0 16 16">
					...
					<tbody>
						<c:forEach items="${salas}" var="salas">
							<tr class="table-active">
								...
								<td><a href="ShowSala?idPelicula=${pelicula.id}"> <svg
