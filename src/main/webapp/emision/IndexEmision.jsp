	...
	<div class="container-fluid">
		<div class="row">
			<div id="barraLateral" class="d-flex col-2 col-sm-3 col-lg-2 flex-nowrap bg-white flex-sm-column flex-column text-start" max-widht="200px">
				...
				<br> 
				<a href="IndexEmision"class="text-body-secondary text-decoration-none fs-5 fw-medium selecionado">Emisiones
				</a> 
				<br> 
			...
			<div class="flex-column col-7 col-sm-8 col-lg-9 mt-4">
				<div class="m-4">
					<a href="CreateEmision"> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" class="bi bi-plus-lg" viewBox="0 0 16 16">
