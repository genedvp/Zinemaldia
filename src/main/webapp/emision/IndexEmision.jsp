...
<body class="bg-dark">
	...
	<div class="container-fluid text-center">
		<div class="row">
			<div id="barraLateral"
				class="d-flex col-2 col-sm-1 col-lg-2 flex-nowrap bg-white flex-sm-column flex-column" max-widht="200px">
				<h2 class="text-body-dark mt-4 fs-1 sm-p">Panel de Control</h2>
				...
				<br> 
				<a href="IndexEmision"
						class="text-body-secondary text-decoration-none fw-medium"> <svg
						xmlns="http://www.w3.org/2000/svg" width="16" height="16"
						fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
                        <path
							d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8M1.173 8a13 13 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5s3.879 1.168 5.168 2.457A13 13 0 0 1 14.828 8q-.086.13-.195.288c-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5s-3.879-1.168-5.168-2.457A13 13 0 0 1 1.172 8z" />
