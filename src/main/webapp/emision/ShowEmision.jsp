	...
	<div class="container">
		...
		<div class="row mt-4">
			<div class="col ">
				...
				<br>
				<p class="text-light"><span class="fw-bold">Pelicula: </span>${pelicula.id}</p>
				<br>
				<p class="text-light"><span class="fw-bold">Sala: </span>${sala.id}</p>
				<br>
				...
				<br>
				<a href="EditPelicula?idPelicula=${emision.id}"> <svg
				...
				</a> <a href="DestroyPelicula?idPelicula=${emision.id}"> <svg
						xmlns="http://www.w3.org/2000/svg" width="25" height="25"
