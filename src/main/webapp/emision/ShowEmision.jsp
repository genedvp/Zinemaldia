...
<body class="bg-dark">
	...
	<div class="container">
		...
		<div class="row mt-4">
			<div class="col ">
				<p class="text-light"><span class="fw-bold">Id: </span>${emision.id}</p>
				<br>
				<p class="text-light"><span class="fw-bold">Pelicula: </span>${emision.pelicula.titulo}</p>
				<br>
				<p class="text-light"><span class="fw-bold">Sala: </span>${emision.sala.descripcion}</p>
				<br>
				<p class="text-light"><span class="fw-bold">Fecha: </span>${emision.fecha}</p>
			    <br>
			    <p class="text-light"><span class="fw-bold">Hora: </span>${emision.hora}</p>
				<br>
				<a href="EditEmision?id=${emision.id}"> <svg
				...
				</a> <a href="DestroyEmision?id=${emision.id}"> <svg
						xmlns="http://www.w3.org/2000/svg" width="25" height="25"
