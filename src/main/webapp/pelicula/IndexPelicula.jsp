	...
	<div class="container-fluid">
		<div class="row">
			<div id="barraLateral" class="d-flex col-2 col-sm-3 col-lg-2 flex-nowrap bg-white flex-sm-column flex-column text-start" max-widht="200px">
				...
				<a href="IndexPelicula" class="text-body-secondary text-decoration-none fs-5 fw-medium selecionado">Peliculas
				</a>
				<br>
				...
				<br> 
				<a href="IndexUsuario" class="text-body-secondary text-decoration-none fs-5 scala">Usuario
				</a>
			</div>
			<div class="flex-column col-7 col-sm-8 col-lg-9 mt-4">
				<div class="m-4">
					<a href="CreatePelicula"> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" class="bi bi-plus-lg" viewBox="0 0 16 16">
				...
				<table class="table table-dark table-striped table-hover">
					<thead>
						<tr class="table-active">
							...
							<th scope="col">año de producción</th>
							<th></th>
						</tr>
					</thead>
					<tbody>
						<c:forEach items="${peliculas}" var="pelicula">
							<tr class="table-active">
								...
								<td><a
									href="ShowPelicula?idPelicula=${pelicula.id}"> <svg
