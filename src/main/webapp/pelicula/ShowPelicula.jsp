...
<body class="bg-dark">
	...
	<div class="container">
		...
		<div class="row mt-4">
			<div class="col ">
				<p class="text-light"><span class="fw-bold">Id: </span>${pelicula.id}</p>
				<br>
				<p class="text-light"><span class="fw-bold">Nombre: </span>${pelicula.titulo}</p>
				<br>
				<p class="text-light"><span class="fw-bold">Director: </span>${pelicula.director}</p>
				<br>
				<p class="text-light"><span class="fw-bold">Descripción: </span>${pelicula.descripcion}</p>
			    <br>
			    <p class="text-light"><span class="fw-bold">Año de Producción: </span>${pelicula.fechaProduccion}</p>
				<br>
				<a href="EditPelicula?idPelicula=${pelicula.id}"> <svg
				...
				</a> <a href="DestroyPelicula?idPelicula=${pelicula.id}"> <svg
						xmlns="http://www.w3.org/2000/svg" width="25" height="25"
