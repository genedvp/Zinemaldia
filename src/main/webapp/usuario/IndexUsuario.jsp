					...
					<tbody>
						<c:forEach items="${usuarios}" var="usuario">
							<tr class="table-active">
								...
								<td>${usuario.rol}</td>
								<td>
								<a href="ShowUsuario?id=${usuario.id}"> <svg
								...
								<td><a href="ShowFactura?id=${usuario.id}" class="text-light"> Ver Facturas</a></td>
							</tr>
						</c:forEach>
